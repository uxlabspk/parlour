...
<head>
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="http://localhost:8080<?php echo $_SERVER['REQUEST_URI']; ?>">
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://localhost:8080<?php echo $_SERVER['REQUEST_URI']; ?>">
    ...
    <meta property="twitter:url" content="http://localhost:8080<?php echo $_SERVER['REQUEST_URI']; ?>">
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="http://localhost:8080/assets/images/favicon.svg">
    <link rel="icon" type="image/x-icon" href="http://localhost:8080/assets/images/favicon.svg">
    <link rel="apple-touch-icon" href="http://localhost:8080/assets/images/favicon.svg">
...
<body class="bg-white text-gray-900 antialiased">
    <nav class="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-5xl">
        <div class="bg-white/95 backdrop-blur-md rounded-2xl shadow-lg shadow-gray-900/5 px-6 py-4 flex items-center justify-between border border-gray-100/80">
            <!-- Logo -->
            <a href="http://localhost:8080/" class="flex items-center gap-2 group" aria-label="Parlour Home - Premium Beauty Salon">
                <img 
                    src="http://localhost:8080/assets/images/logo.png" 
            ...
            <div class="flex items-center gap-2">
                <!-- Cart -->
                <a href="http://localhost:8080/cart.php" class="relative p-2.5 hover:bg-gray-100 rounded-xl transition-colors duration-200 group">
                ...
                <?php if (isLoggedIn()): ?>
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 mt-3 w-60 bg-white rounded-2xl shadow-xl shadow-gray-900/10 border border-gray-100 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 animate-fade-in">
                            ...
                            <?php if (isManager()): ?>
                                <a href="http://localhost:8080/admin/index.php" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors">
                            ...
                            <?php endif; ?>
                            <a href="http://localhost:8080/profile.php" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <?php if (!isManager()): ?>
                                <a href="http://localhost:8080/profile.php?tab=orders" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="border-t border-gray-100 mt-2 pt-2">
                                <a href="http://localhost:8080/auth/logout.php" class="flex items-center gap-3 px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php else: ?>
                    <a href="http://localhost:8080/auth/login.php" class="hidden md:flex items-center gap-2 px-5 py-2.5 bg-gray-900 text-white text-sm font-medium rounded-xl hover:bg-gray-800 transition-colors duration-200">
                        Sign In
                    </a>
                <?php endif; ?>
        ...
        <div id="mobileMenu" class="hidden lg:hidden absolute top-full left-0 right-0 mt-3 bg-white rounded-2xl shadow-xl shadow-gray-900/10 border border-gray-100 overflow-hidden animate-slide-up">
            <div class="py-2">
                <a href="http://localhost:8080/" class="flex items-center gap-3 px-5 py-3.5 text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors">
                ...
                <a href="http://localhost:8080/shop.php" class="flex items-center gap-3 px-5 py-3.5 text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/>
                    </svg>
                    Shop
                </a>
                <a href="http://localhost:8080/about.php" class="flex items-center gap-3 px-5 py-3.5 text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    About
                </a>
                <a href="http://localhost:8080/contact.php" class="flex items-center gap-3 px-5 py-3.5 text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if (!isLoggedIn()): ?>
                    <div class="border-t border-gray-100 mt-2 pt-2 px-4 pb-3">
                        <a href="http://localhost:8080/auth/login.php" class="flex items-center justify-center gap-2 w-full py-3 bg-gray-900 text-white text-sm font-medium rounded-xl hover:bg-gray-800 transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
